        ...
        if len(input_vid) < 24:
            ...
            if pred[0][0]> .95:
                ...
                for (top, right, bottom, left), name in zip(face_locations, face_names):
                    ...
                    if unlock:
                        cv2.putText(frame, 'Live Confrimed', (frame.shape[1]//2, frame.shape[0]//2), font, 1.0, (255, 255, 255), 1)
                    else:
                        cv2.putText(frame, ' ', (frame.shape[1]//2, frame.shape[0]//2), font, 1.0, (250, 255, 250), 2)
               
            else:
                cv2.putText(frame, 'Not Live', (frame.shape[1]//2, frame.shape[0]//2), font, 1.0, (0, 0, 255), 2)
